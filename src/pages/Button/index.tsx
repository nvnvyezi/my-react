            ...
            <main className={`${prefixCls}-code-content`}>
              <section className={`${prefixCls}-code-content-box`}>
                ...
                <div className={`${prefixCls}-box-info`}>
                  ...
                  <pre>
                    <code>&lt;Button type=&quot;&quot;&gt;Primary&lt;/Button&gt;</code>
                  </pre>
                </div>
              </section>
              <section className={`${prefixCls}-code-content-box`}>
                ...
                <div className={`${prefixCls}-box-info`}>
                  ...
                  <p>按钮有大、中、小三种尺寸。<br />通过设置 <code>size</code> 为 <code>large</code> <code>small</code> 分别把按钮设为大、小尺寸。若不设置 <code>size</code>，则尺寸为中。</p>
                </div>
                <div className={`${prefixCls}-box-info`}>
                  <div className={`${prefixCls}-info-title`}>
                    <span>代码示例</span>
                  ...
                  <pre>
                    <code>&lt;Button type=&quot;&quot; size=&quot;&quot;&gt;Primary&lt;/Button&gt;</code>
                  </pre>
                </div>
              </section>
              <section className={`${prefixCls}-code-content-box`}>
              ...
              <section className={`${prefixCls}-code-content-box`}>
                ...
                <div className={`${prefixCls}-box-info`}>
                  ...
                  <p>添加 <code>shape</code> 属性即可让按钮处于规定状态。</p>
                </div>
                <div className={`${prefixCls}-box-info`}>
                  <div className={`${prefixCls}-info-title`}>
                    <span>代码示例</span>
                  ...
                  <pre>
                    <code>&lt;Button type=&quot;&quot; shape="circle"&gt;Primary&lt;/Button&gt;</code>
                  </pre>
                </div>
              </section>
              <section className={`${prefixCls}-code-content-box`}>
                ...
                <div className={`${prefixCls}-box-info`}>
                  ...
                  <pre>
                    <code>&lt;Button type=&quot;&quot; size=&quot;&quot; loading&gt;Primary&lt;/Button&gt;</code>
                  </pre>
                </div>
              </section>
              <section className={`${prefixCls}-code-content-box`}>
                ...
                <div className={`${prefixCls}-box-info`}>
                  ...
                  <p><code>block</code> 属性将使按钮适合其父宽度。</p>
                </div>
                <div className={`${prefixCls}-box-info`}>
                  <div className={`${prefixCls}-info-title`}>
                    <span>代码示例</span>
                  ...
                  <pre>
                    <code>&lt;Button block&gt;Primary&lt;/Button&gt;</code>
                  </pre>
                </div>
              </section>
              <section className={`${prefixCls}-code-content-box`}>
                ...
                <div className={`${prefixCls}-box-info`}>
                  ...
                  <p><code>ghost</code> 幽灵按钮将按钮的内容反色，背景变为透明，常用在有色背景上。</p>
                </div>
                <div className={`${prefixCls}-box-info`}>
                  <div className={`${prefixCls}-info-title`}>
                    <span>代码示例</span>
                  ...
                  <pre>
                    <code>&lt;Button ghost&gt;Primary&lt;/Button&gt;</code>
                  </pre>
                </div>
              </section>
            </main>
